...
export const detect = (text: string, languageCodeFormat: LanguageCodeFormat ) => {
	const code6393 = franc(text);
	const code6391 = iso6393To1[code6393];
	console.log("three: " + code6393)
	console.log("two: "+code6391)
	if (!code6391) return undefined;

	const languageCode = languageCodeFormat === LanguageCodeFormat.TwoLetter ? code6391 : code6393;
